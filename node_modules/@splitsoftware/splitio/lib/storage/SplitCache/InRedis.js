...
var SplitCacheInRedis = /*#__PURE__*/function () {
  ...
  var _proto = SplitCacheInRedis.prototype;
  ...
  _proto.trafficTypeExists = function trafficTypeExists(trafficType) {
    ...
    return this.redis.get(this.keys.buildTrafficTypeKey(trafficType)).then(function (ttCount) {
      ...
      log.error("Could not validate traffic type existance of " + trafficType + " due to an error: " + e + "."); // If there is an error, bypass the validation so the event can get tracked.
