...
function GET(settings, noCache) {
   ...
   */
  return (0, _request.default)(settings, "/mySegments/" + encodeURIComponent((0, _factory.matching)(settings.core.key)), undefined, noCache ? _request.noCacheExtraHeader : undefined);
}