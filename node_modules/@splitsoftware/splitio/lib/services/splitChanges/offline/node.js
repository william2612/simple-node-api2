...
function configFilesPath(config) {
  ...
  if (!((0, _lang.endsWith)(configFilePath, '.yaml', true) || (0, _lang.endsWith)(configFilePath, '.yml', true) || (0, _lang.endsWith)(configFilePath, '.split', true))) throw new Error("Invalid extension specified for Splits mock file. Accepted extensions are \".yml\" and \".yaml\". Your specified file is " + configFilePath);
  if (!_fs.default.existsSync(configFilePath)) throw new Error("Split configuration not found in " + configFilePath + " - Please review your Split file location.");
